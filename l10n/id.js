OC.L10N.register(
    ...
    "Restart" : "Mulai ulang",
    "Rewind {seektime}s" : "Mundur {seektime} dtk",
    "Play" : "Putar",
    "Pause" : "Jeda",
    "Forward {seektime}s" : "Maju {seektime} dtk",
    "Seek" : "Cari",
    "{currentTime} of {duration}" : "{currentTime} dari {duration}",
    "Played" : "Telah diputar",
    "Buffered" : "Telah dimuat",
    "Current time" : "Waktu saat ini",
    "Duration" : "Durasi",
    "Volume" : "Volume",
    "Mute" : "Bisukan",
    "Unmute" : "Aktifkan suara",
    "Enable captions" : "Aktifkan teks terjemahan",
    "Disable captions" : "Nonaktifkan teks terjemahan",
    "Enter fullscreen" : "Masuk ke layar penuh",
    "Exit fullscreen" : "Keluar dari layar penuh",
    "Player for {title}" : "Pemutar untuk {title}",
    "Captions" : "Teks terjemahan",
    "Settings" : "Pengaturan",
    "PIP" : "Gambar dalam Gambar",
    "Go back to previous menu" : "Kembali ke menu sebelumnya",
    "Speed" : "Kecepatan",
    "Normal" : "Normal",
    "Loop" : "Ulangi",
    "Start" : "Mulai",
