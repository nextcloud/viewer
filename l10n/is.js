OC.L10N.register(
    ...
    "Restart" : "Byrja aftur",
    "Rewind {seektime}s" : "Spóla til baka {seektime}s",
    "Play" : "Spila",
    "Pause" : "Í bið",
    "Forward {seektime}s" : "Spóla áfram {seektime}s",
    "Seek" : "Leita",
    "{currentTime} of {duration}" : "{currentTime} af {duration}",
    "Played" : "Spilað",
    "Buffered" : "Sett í biðminni",
    "Current time" : "Tími núna",
    "Duration" : "Tímalengd",
    "Volume" : "Hljóðstyrkur",
    "Mute" : "Þagga",
    "Unmute" : "Hljóð á",
    "Enable captions" : "Virkja skjátexta",
    "Disable captions" : "Gera skjátexta óvirka",
    "Enter fullscreen" : "Fara í skjáfylli",
    "Exit fullscreen" : "Hætta í skjáfylli",
    "Player for {title}" : "Spilari fyrir {title}",
    "Captions" : "Skjátextar",
    "Settings" : "Stillingar",
    "PIP" : "PIP",
    "Go back to previous menu" : "Fara til baka í fyrri valmynd",
    "Speed" : "Hraði",
    "Normal" : "Venjulegt",
    "Loop" : "Endurtaka",
    "Start" : "Byrjun",
