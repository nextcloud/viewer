OC.L10N.register(
    ...
    "You are about to overwrite the original file. Are you sure you want to continue?" : "Вы собираетесь перезаписать исходный файл. Вы уверены, что хотите продолжить?",
    "A file with this name already exists. Do you want to overwrite it?" : "Файл с таким именем уже существует. Вы хотите перезаписать его?",
    "Confirm overwrite" : "Подтвердите перезапись",
    "Overwrite" : "Перезаписать",
    "Cancel" : "Отменить",
    "An error occurred while trying to confirm the file overwrite." : "Произошла ошибка при попытке подтвердить перезапись файла.",
    "Image saved" : "Изображение сохранено",
    "Error saving image" : "Не удалось сохранить изображение",
    "Play the live photo" : "Воспроизвести живое фото",
    "LIVE" : "ТРАНСЛИРУЕТСЯ",
    ...
    "Failed to save file before download" : "Не удалось сохранить файл перед загрузкой",
    "Edit" : "Редактировать",
    ...
    "+ Add text watermark" : "+ Добавить текстовый водяной знак",
    ...
    "Select image to add …" : "Выберите изображение для добавления …",
    "Failed to load image." : "Не удалось загрузить изображение.",
    "Menu" : "Меню",
    "Width" : "Ширина",
    "Height" : "Рост",
    "No preview available for this crop item" : "Предварительный просмотр этого элемента обрезки недоступен",
    "Restart" : "Перезапуск",
    "Play" : "Воспроизвести",
    "Pause" : "Пауза",
